...
void Compress(unsigned long long input_bytes, std::ifstream* is,
  ...
  while (pos < input_bytes) {
    const size_t chunk = static_cast<size_t>(
        std::min<unsigned long long>(buffer_size, input_bytes - pos));
